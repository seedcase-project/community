...
had intended to wrote up and share as a post, but it was always low
priority so never got around to it. We've been making some good
progress, so I've gotten some time to finally write up a post on my
...
World War II. The community agreed on definition of ResearchOps is:
...
-   Senior management listens strongly to cost-benefit analysis, so do
