...
On July 3rd, 2025, we finally published our first release of our first
...
which is the first of our planned four packages. Of the four packages,
...
> Grow structured, organised, and usable data
...
-   We should explicitly include a dedicated design brainstorming phase
    ...
    that). And to include lots of time to really critique and discuss
