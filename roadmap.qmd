...
They are split into three main categories: software and software-related, technical
...
-   {{< var status.done >}}: Products we have completed a minimally
    viable product (MVP) of. As products are never truly
...
-   {{< var status.planned >}}: Products we plan to work on and aim to
    complete within the current funding period (end of 2027).
-   {{< var status.potential >}}: Products we are very interested in
    working on, but given the time and resources, may likely not get to
    within the current funding period (end of 2027).
...
After the first release of a MVP and if it gets
sufficient use, it will continue to be tested and refined based on user
feedback and identified bugs.
...
| {{< var status.wip >}} | [`seedcase-project/spaid`](https://github.com/seedcase-project/spaid): A toolkit for developing Seedcase projects. |
...
: "Wishlist" of software-related products we are currently working on, will
work on, or hope to work on.

### Technical documentation

Following the [diátaxis](https://diataxis.fr/) method to structuring
documentation, documentation is split up into four types: learning
...
Learning includes courses, brief tutorials, and learning shorts. These
will be developed as [open educational
...
| {{< var status.planned >}} | Sprout data extensions usage guide: Installing or creating extensions for `seedcase-sprout`. |
...
: "Wishlist" of goal-type documentation products we are currently working
...
: "Wishlist" of informational-type documentation products we are currently
working on, will work on, or hope to work on.

### Explanations

This includes opinion pieces, explanations, theoretical or
thought-provoking pieces, and outreach materials.
...
: "Wishlist" of outreach event "products" we are currently working on, will
work on, or hope to work on.
