...
description: |
    ...
    be collaborating with them on their data infrastructure, engineering, and (technical)
...
project as well as in implementing and ensuring the research follows
...
We have many things to still discuss with our involvement, but the tasks
...
The DP-Next project doesn't official start until September 2025, so we
...
collaboration in later in the year! :tada:
