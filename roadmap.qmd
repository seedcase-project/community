...
: Approximate timeline for completion of a Minimally Viable Product (prototype).

### Documentation

While we want the software products to have a more tangible deliverable and timeline, we will be continually updating and refining documentation related. At some regular intervals, we plan on uploading the documents to an archive for generating DOIs and for greater dissemination.

| Status | Timeline | Deliverable | Description |
|---|---|----|-----|
| {{< var status.wip >}} | End 2025 | [`seedcase-project/decisions`](https://github.com/seedcase-project/decisions) | Records on most of the decisions made in the Seedcase Project |
...
: Secondary software deliverables with their approximate timeline for completion of a Minimally Viable Product (prototype) for each.
...
Once we have a Minimally Viable Product for any of the software deliverables, we aim to test and deploy them in real-world projects. We have several projects lined up for this:
