...
::: callout-important
While I attended this symposium on June 10-11, 2024 and I had wanted to
write this blog post earlier, I was very busy and it was always low on
...
2023*](https://sciencecluster.dk/event/cross-cluster-collaboration-data-science-for-planetary-and-human-health/)
...
fields of research. The summary they provide for the symposium is:
...
These are an honest, if sometimes critical, reflection of what I saw and
heard at the symposium (and often frequently experience at other
conferences too).
...
-   *Presentations that make many assumptions about the knowledge of the
    ...
    audience enough to spend their own time to making sure the
...
-   *There were very few topics or sessions on data engineering,
    ...
    opportunity for the symposium, since part of it's stated aim was
...
-   *A lot of presentations and topics were on data in general (or
    ...
    previous point, that so often, we in research focus on the data
    collection and the analytics, but we don't focus on the data
    engineering and infrastructure that is needed to support the data
    collection and analytics. Even within grant applications, we write
...
-   Further emphasized the strong fundamental need for more data
...
-   Even projects that are doing similar work as ours towards building
    data infrastructures, they are closed source or not publicly
    accessible and it isn't obvious how it can be used in other
    contexts. Which highlights the niche that Seedcase is aiming to fill
...
-   Most projects and initiatives are not guided and driven by strong
    ...
    these principles and designs takes time, so it can seem that we are
    ...
    rigorous, and high-quality work that will last well into the future.
...
-   One of the final presentations by Lars Juhl Jensen was especially
    good, since he showed how to give an engage and informative
...
incorporate or consider in some way in the Seedcase Project. It further
