...
and use Sprout. But I'll give you a quick look at some of the features
of using Sprout to create a data package. I won't go into how to install
it, as that is well described in the guide. Instead I'll show you some
...
has the `extract_field_properties()` function. The helpful part comes
when you want to add data to the package and need a starting point to
describe the data itself in the metadata. So you can import the data
...
of the data. Once you've edited this script, you can than use `import`
...
Aside from our main goal of having a working package that works as
...
-   Include documentation on the design of Sprout as well as how to use
    it.
...
different things involved in building a well-built, well-tested, secure,
...
make, we can use that as a starting point, while also keeping those
