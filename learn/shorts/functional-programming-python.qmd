...
matches our ethos. This second learning short is a continuation of [A
brief introduction to functional
programming](!--TODO%20insert%20link--), in which we discussed the
...
programming in Python without going into too much programming detail.
...
many functional programming features are built-in and easy to use. This
