...
updated. So here we define deliverable for software as the first
Minimally Viable Product (or prototype). After the first release of a
Minimally Viable Product, the software product will continue to be
tested and refined based on user feedback, identifying bugs, and adding
features.

Likewise, our non-software projects will also continue to be refined and
updated. So we define deliverable as the first time they are uploaded to
...
: Approximate timeline for completion of a Minimally Viable Product
(prototype).

### Documentation

While we want the software products to have a more tangible deliverable
and timeline, we will be continually updating and refining documentation
related. At some regular intervals, we plan on uploading the documents
...
| Status | Timeline | Deliverable | Description |
|--------|----------|-------------|-------------|
| {{< var status.planned >}} | TDB | Tutorial | Installing and setting up Seedcase on a server so Data Resources can be created |
| {{< var status.planned >}} | TDB | Tutorial | Using Seedcase to create and manage a Data Resource |
| {{< var status.planned >}} | TDB | Tutorial | Requesting to start a data project for a Data Resource |
...
completion of a Minimally Viable Product (prototype) for each.
...
Once we have a Minimally Viable Product for any of the software
